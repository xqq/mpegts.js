...
// The OBUs (as hex) and key frame flag of each queued sample, copied into arrays of this realm:
// the demuxer runs in its own vm context
function queuedSamples(demuxer) {
    return Array.from(demuxer.video_track_.samples, sample => ({
